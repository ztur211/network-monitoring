...
import { DeviceFocusContextProvider } from './context/device-focus-context.provider';
...
@Module({
  imports: [PrismaModule, RedisModule, DataSourcesModule, PermissionsModule, MonitoringModule],
  ...
  providers: [
    ...
    { provide: DEVICE_FOCUS_CONTEXT_PROVIDER, useClass: DeviceFocusContextProvider },
