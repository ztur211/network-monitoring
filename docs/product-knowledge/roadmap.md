...
- **Desktop Agent** (planned): A lightweight background agent for macOS, Windows, and Linux that provides richer device metrics without requiring the browser tab to be open. Enables monitoring of remote devices.
