...
public class BuildingModelRealtimeTests
{
    ...
    public async Task Org_room_hears_the_model_version_lifecycle_uploaded_activated_deleted()
    {
        ...
        var v1 = await UploadVersionAsync(buildingId, org.OwnerCookie);
        ...
        var v2 = await UploadVersionAsync(buildingId, org.OwnerCookie);
        ...
        var delete = await _api.DeleteAsync($"v1/buildings/{buildingId}/model/versions/{v2}", org.OwnerCookie);
