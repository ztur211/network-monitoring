...
public sealed class MapE2ETests : IDisposable
{
    ...
    /// <summary>Plays the demo owner's browser: sign-in cookie in, nodescope:// Location out.</summary>
    private sealed class SignInBrowser : IBrowserLauncher, IDisposable
    {
